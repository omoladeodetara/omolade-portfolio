...
export function DashboardGallery({ images, title, className }: DashboardGalleryProps) {
  const [currentIndex, setCurrentIndex] = useState(0)
  const [fullscreenImage, setFullscreenImage] = useState<DashboardImage | null>(null)
